    ...
    public class FolhaPagamentoController : Controller
    {
        ...
        public List<FolhaPagModel> listaFolhaPagamento()
        {
            ...
            using (SqlConnection conexaoDB = new SqlConnection(conexaoSQL))
            {
                ...
                string query = @"
                    SELECT Folha_pagamento.*, Funcionarios.*, 
                    ...
                    INNER JOIN Funcionarios ON Folha_pagamento.Id_funcionario = Nome.Id_funcionario
                    INNER JOIN Funcionarios ON Folha_pagamento.Id_funcionario = Cargo.Id_funcionario";
